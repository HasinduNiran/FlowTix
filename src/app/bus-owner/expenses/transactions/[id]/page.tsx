...
import { OwnerExpenseTransactionService, OwnerExpenseTransaction } from '@/services/ownerExpense.service';
...
export default function TransactionDetailPage() {
  ...
  const handleDelete = async () => {
    ...
    setConfirmModalConfig({
      ...
      message: `Are you sure you want to delete this transaction worth Rs. ${transaction.amount.toLocaleString()}? This action cannot be undone.`,
  ...
  const confirmDelete = async () => {
    try {
      ...
      await OwnerExpenseTransactionService.deleteExpenseTransaction(id);
          ...
          <div className="bg-white/70 backdrop-blur-sm shadow-xl rounded-3xl p-8 border border-white/50">
              ...
              <ol className="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm font-medium text-blue-600 md:ml-2 truncate">Rs. {transaction.amount.toLocaleString()}</span>
                  </div>
                </li>
              </ol>
            </nav>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              ...
              <div className="flex space-x-3">
                ...
                <Button
                  onClick={() => router.push(`/bus-owner/expenses/transactions/${id}/edit`)}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-900 whitespace-pre-wrap">{transaction.notes || 'No notes provided'}</p>
                </div>
