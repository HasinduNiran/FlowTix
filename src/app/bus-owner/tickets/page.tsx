      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            ...
            <div className="bg-gradient-to-br from-white to-green-50 rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
              <div className="flex items-center">
            ...
            <div className="bg-gradient-to-br from-white to-purple-50 rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 uppercase tracking-wider">Total Revenue</p>
            ...
            <div className="bg-gradient-to-br from-white to-yellow-50 rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
              <div className="flex items-center">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-100 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 uppercase tracking-wider">Cash Collected</p>
                  <p className="text-sm sm:text-lg lg:text-xl font-bold text-gray-900 truncate">
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <p className="text-xs text-gray-400">
                                  {getConductorDisplay(ticket.conductorId)}
                                </p>
                              </div>
                            </div>
